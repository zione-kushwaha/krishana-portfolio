...
import 'package:krishna/responsive/src/screen_data.dart';
...
extension HelperExtension on ScreenData {
  ...
  EdgeInsets get contentPadding => EdgeInsets.symmetric(
    horizontal: fromMTD(20, 50, fromDesktop(w(5), w(10), w(15))),
  );
  ...
  T? adaptive<T>({T? defaultValue, T? mobile, T? tablet, T? desktop}) {
    assert(
      mobile != null ||
          tablet != null ||
          desktop != null ||
